...
import com.wdy.cheemate.annotation.*;
import com.wdy.cheemate.aspect.*;
import com.wdy.cheemate.common.util.ComUtil;
import com.wdy.cheemate.common.util.StringUtil;
...
public class ControllerAspect {
    ...
    @Pointcut("execution(* com.wdy.cheemate.controller..*(..))  ")
    public void aspect() {
    }
